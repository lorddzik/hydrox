...
class ComposeMessageWithAI(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        tone (:obj:`InputAiComposeTone <hydrogram.raw.base.InputAiComposeTone>`, *optional*):
            N/A

    Returns:
        :obj:`messages.ComposedMessageWithAI <hydrogram.raw.base.messages.ComposedMessageWithAI>`
    """
