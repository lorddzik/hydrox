...
class InputRichMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hydrogram.raw.base.InputRichMessage`.
    ...
    Parameters:
        ...
        photos (List of :obj:`InputPhoto <hydrogram.raw.base.InputPhoto>`, *optional*):
            N/A

        documents (List of :obj:`InputDocument <hydrogram.raw.base.InputDocument>`, *optional*):
            N/A
