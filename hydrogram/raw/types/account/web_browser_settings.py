...
class WebBrowserSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hydrogram.raw.base.account.WebBrowserSettings`.
    ...
    Parameters:
        external_exceptions (List of :obj:`WebDomainException <hydrogram.raw.base.WebDomainException>`):
            N/A

        inapp_exceptions (List of :obj:`WebDomainException <hydrogram.raw.base.WebDomainException>`):
            N/A
