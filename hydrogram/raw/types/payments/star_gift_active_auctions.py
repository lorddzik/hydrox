...
class StarGiftActiveAuctions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hydrogram.raw.base.payments.StarGiftActiveAuctions`.
    ...
    Parameters:
        auctions (List of :obj:`StarGiftActiveAuctionState <hydrogram.raw.base.StarGiftActiveAuctionState>`):
            N/A
